        ...
        switch (currentPoint)
        {
            case 5:
                ...
                switch (enemySpwn) {
                    ...
                    case 2:
                        if (pickups == 0)
                            transform.rotation = Quaternion.Slerp(transform.rotation, Quaternion.Euler(0, 65f, 0), Time.deltaTime * smooth5);
                        break;
                    case 1:
                        if (pickups == 0)
                            transform.rotation = Quaternion.Slerp(transform.rotation, Quaternion.Euler(0, -90f, 0), Time.deltaTime * smooth5);
                        break;
                }
                break;
            case 6:
            ...
            case 10:
                ...
                switch (enemySpwn)
                {
                    ...
                    case 4:
                        if (pickups == 0)
                            transform.rotation = Quaternion.Slerp(transform.rotation, Quaternion.Euler(0, 0, 0), Time.deltaTime * smooth10);
                        break;
                    case 2:
                        if (pickups == 0)
                            transform.rotation = Quaternion.Slerp(transform.rotation, Quaternion.Euler(0, 200f, 0), Time.deltaTime * smooth10);
                        break;
                }
                break;
            case 11:
